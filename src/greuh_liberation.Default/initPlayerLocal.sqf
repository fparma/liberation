...
// Redeploy
[ACE_player, 1, ["ACE_SelfActions", "FPC_INTERACTION_ROOT"], ['FPC_INTERACTION_REDEPLOY','Redeploy','',{GRLIB_force_redeploy = true;},{[] call FPC_fnc_redeployCondition;}] call ace_interact_menu_fnc_createAction] call ace_interact_menu_fnc_addActionToObject;
