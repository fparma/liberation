...
mb_fnc_InitialWeather = {
  ...
  private _weatherInitialArray = weatherTemplates select rw2_Current_Weather;
  weatherCurrentName = _weatherInitialArray select 0;
  private _weatherInitialSettings = _weatherInitialArray select 2;
  private _weatherInitialOvercast = _weatherInitialSettings select 0;
  private _weatherInitialRainSnow = _weatherInitialSettings select 1;
  private _weatherInitialFog = _weatherInitialSettings select 2;
  private _weatherInitialWindEW = _weatherInitialSettings select 3;
  private _weatherInitialWindNS = _weatherInitialSettings select 4;
...
if (isServer) then {
  ...
  if(isNil('paramsArray')) then {
    ...
    initialWeatherParam = ["StartingWeather",4] call bis_fnc_getParamValue;
