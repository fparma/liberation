...
<#define MAIN_TRUCK|"rhssaf_army_ural">                         // FOB Transport Truck
<#define MAIN_TRUCK_RESPAWN|"rhssaf_army_ural_open">             // Mobile Respawn Vehicle
...
<#define MAIN_TRANSPORT_HELO|"rhssaf_airforce_ht48">           // Main Transport helicopter (Transporting FOB Capable)
...
<#define BLUFOR_UNIT_GRENADIER|"rhsusf_army_m93_oakleaf_grenadier">     
...
<#define OPFOR_UNIT_SQL|"rhsusf_usmc_marpat_wd_squadleader">                     // Squadleader
<#define OPFOR_UNIT_FTL|"rhsusf_usmc_marpat_wd_teamleader">                     // Fireteam Leader
<#define OPFOR_UNIT_OFFICER|"rhsusf_usmc_marpat_wd_officer">                    // Officer
<#define OPFOR_UNIT_RIFLEMAN|"rhsusf_usmc_marpat_wd_rifleman_m4">                   // Rifleman
<#define OPFOR_UNIT_GRENADIER|"rhsusf_usmc_marpat_wd_grenadier">               // Grenadier
<#define OPFOR_UNIT_AUTORIFLEMAN|"rhsusf_usmc_marpat_wd_autorifleman">            // Autorifleman (LMG)
<#define OPFOR_UNIT_MEDIC|"rhsusf_usmc_marpat_wd_rifleman_law">                        // Medic
<#define OPFOR_UNIT_MARKSMAN|"rhsusf_usmc_marpat_wd_marksman">                 // Marksman
<#define OPFOR_UNIT_ENGINEER|"rhsusf_usmc_marpat_wd_engineer">                  // Engineer
<#define OPFOR_UNIT_LAT|"rhsusf_usmc_marpat_wd_riflemanat">                    // Light AT
<#define OPFOR_UNIT_HAT|"rhsusf_usmc_marpat_wd_javelin">                     // Dedicated AT
<#define OPFOR_UNIT_AA|"rhsusf_usmc_marpat_wd_stinger">                      // Anti Air
<#define OPFOR_UNIT_MMG|"rhsusf_usmc_marpat_wd_machinegunner">                     // Medium Machine Gunner
<#define OPFOR_UNIT_SNIPER|"rhsusf_usmc_marpat_wd_sniper_M107">                      // Sniper
<#define OPFOR_UNIT_SHARPSHOOTER|"rhsusf_usmc_marpat_wd_sniper">               // Sharpshooter
<#define OPFOR_UNIT_CREWMAN|"rhsusf_usmc_marpat_wd_combatcrewman">                       // Crewman
